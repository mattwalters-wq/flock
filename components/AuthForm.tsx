...
18" fill="none" aria-hidden>
      <path d="M17.
9.2c0-.637-.057-1.251-.164-1.84H9v3.481h4.844c-.
1.125-.
2.078-1.
2.717v2.258h2.908c1.702-1.
2.684-3.
2.684-6.615z" fill="#4285F4"/>
      <path d="M
18c2.

4.467-.
5.956-2.184l-2.908-2.258c-.806.54-1.837.86-3.048.86-2.
0-4.328-1.584-5.036-3.711H.957v2.332A8.
8.
...
3.
9c0-.593.102-1.17.282-1.707V4.961H.957A8.
8.
...
1.452.
2.827.
4.039l3.007-2.332z" fill="#FBBC05"/>
      <path d="M
3.58c1.

2.508.
3.
1.345l2.582-2.58C13.463.
11.
...
16" fill="none" aria-hidden
      style={{ animation: 'auth-spin 0.7s linear infinite', flexShrink:
}}
    >
...
0-6-6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
  )
}
